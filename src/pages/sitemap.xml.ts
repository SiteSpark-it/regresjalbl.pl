...
const staticPages = [
  { path: '/', priority: '1.0', changefreq: 'weekly', lastmod: '2026-07-19' },
  ...
  { path: '/faq/', priority: '0.7', changefreq: 'monthly', lastmod: '2026-07-19' },
  { path: '/polityka-prywatnosci/', priority: '0.3', changefreq: 'yearly', lastmod: '2026-07-19' }
];
