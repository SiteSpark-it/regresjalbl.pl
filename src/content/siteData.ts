...
export const blogTopics = [
  ...
  {
    phrase: 'LBL a PLR',
    intent: 'Dla osób, które porównują regresję poprzednich wcieleń i pracę między wcieleniami.',
    h1: 'LBL a PLR: proste rozróżnienie bez mieszania pojęć',
    h2: ['Czym jest PLR?', 'Czym jest LBL?', 'Co może je łączyć?', 'Jak wybrać właściwy kierunek pracy'],
    links: ['/regresja-poprzednich-wcielen/', '/regresja-miedzy-wcieleniami/', '/faq/'],
    cta: 'Zacznij od spokojnego porównania metod'
  },
  {
  ...
  },
  {
    ...
    intent: 'Dla osób, które szukają spokojnego wyjaśnienia bez taniej ezoteryki.',
    h1: 'Regresja poprzednich wcieleń: duchowo, symbolicznie czy psychologicznie?',
    h2: ['Różne sposoby rozumienia doświadczenia', 'Dlaczego nie trzeba wymuszać wiary?', 'Co daje integracja po sesji?', 'Jak mówić o tym odpowiedzialnie'],
    links: ['/regresja-poprzednich-wcielen/', '/regresja-miedzy-wcieleniami/', '/o-macieju/'],
    cta: 'Zobacz, jak wygląda odpowiedzialne przygotowanie do sesji'
  },
  {
    phrase: 'przygotowanie do sesji regresji',
  ...
  {
    phrase: 'czy regresja jest bezpieczna',
    intent: 'Dla osób, które mają obawy i potrzebują jasnych granic.',
    h1: 'Czy regresja duchowa jest bezpieczna? Granice, przeciwwskazania i zdrowy rozsądek',
    h2: ['Co zwiększa bezpieczeństwo?', 'Kiedy nie iść na sesję?', 'Różnica między rozwojem a leczeniem', 'Jak rozpoznać odpowiedzialny opis usługi'],
    links: ['/faq/', '/sesja/', '/o-macieju/'],
    cta: 'Zadaj pytania przed decyzją o sesji'
  },
  {
    phrase: 'integracja po regresji',
    intent: 'Dla osób, które chcą wiedzieć, co zrobić po intensywnym doświadczeniu.',
    h1: 'Integracja po regresji: jak spokojnie pracować z tym, co się pojawiło',
    h2: ['Dlaczego nie interpretować wszystkiego od razu?', 'Notatki po sesji', 'Codzienność i relacje', 'Kiedy szukać dodatkowego wsparcia'],
    links: ['/regresja-miedzy-wcieleniami/', '/sesja/', '/faq/'],
    cta: 'Czytaj dalej o przebiegu sesji'
  },
  {
    phrase: 'regresja duchowa a psychoterapia',
    intent: 'Dla osób, które porównują usługę rozwojową z pomocą kliniczną.',
    h1: 'Regresja duchowa a psychoterapia: gdzie przebiega granica?',
    h2: ['Czym jest praca rozwojowa?', 'Czego regresja nie zastępuje?', 'Kiedy potrzebna jest pomoc specjalistyczna?', 'Jak uczciwie opisać własne oczekiwania'],
    links: ['/faq/', '/sesja/', '/o-macieju/'],
    cta: 'Podejmij decyzję bez presji i bez obietnic'
  }
];
